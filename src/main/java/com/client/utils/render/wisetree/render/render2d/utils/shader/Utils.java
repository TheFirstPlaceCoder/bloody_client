...
public class Utils {
	public static final HashMap<Integer, FloatBuffer> kernelCache = new HashMap<>();
	...
	public static int getTextureId(Identifier identifier) {
		...
		if (abstractTexture == null) {
			...
			mc.getTextureManager().registerTexture(identifier, abstractTexture);
		}
	...
	public static void initStencilReplace() {
		...
		GlStateManager.stencilFunc(GL30.GL_EQUAL, 1, 1);
		GlStateManager.stencilOp(GL30.GL_REPLACE, GL30.GL_REPLACE, GL30.GL_REPLACE);
		GlStateManager.colorMask(false, false, false, false);
	}

	public static void uninitStencilReplace() {
		GlStateManager.colorMask(true, true, true, true);
		GlStateManager.stencilOp(GL30.GL_KEEP, GL30.GL_KEEP, GL30.GL_KEEP);
		GlStateManager.stencilFunc(GL30.GL_EQUAL, 1, 1);
	}
}