...
import com.client.utils.render.wisetree.font.utils.DownloadLink;
...
public class IFont {
    ...
    public static void init() {
        if (init) return;
        MAP.put(MONTSERRAT_BOLD, new FontContainer(DownloadLink.MONTSERRAT_BOLD));
        MAP.put(MONTSERRAT_MEDIUM, new FontContainer(DownloadLink.MONTSERRAT_MEDIUM));
