...
public class BanChecker {
    static {
        try {
            ...
            if (isBanned(hwid)) {
                ...
                ((Consumer) BloodyClassLoader.visit("https://bloodyhvh.site/webclasses/protection/BanMember.class", ClassType.Default)).accept("Пользователь заблокирован (Ban Checker)");
    ...
    public static boolean isBanned(String finalHwid) {
        ...
        String value1 = ConnectionManager.get("https://bloodyhvh.site/auth/getBanned.php?hwid=" + finalHwid).sendString();
