...
public class SoundManager {
    ...
    private static final Identifier BUBBLE_SOUND = new Identifier("bloody-client:bubble");
    private static final Identifier BUTTON_SOUND = new Identifier("bloody-client:button");
    private static final Identifier CLICK_SOUND = new Identifier("bloody-client:click");
    ...
    public static SoundEvent BUBBLE_EVENT = new SoundEvent(BUBBLE_SOUND);
    public static SoundEvent BUTTON_EVENT = new SoundEvent(BUTTON_SOUND);
    public static SoundEvent CLICK_EVENT = new SoundEvent(CLICK_SOUND);
    ...
    public static void init() {
        ...
        Registry.register(Registry.SOUND_EVENT, BUBBLE_SOUND, BUBBLE_EVENT);
        Registry.register(Registry.SOUND_EVENT, BUTTON_SOUND, BUTTON_EVENT);
        Registry.register(Registry.SOUND_EVENT, CLICK_SOUND, CLICK_EVENT);
