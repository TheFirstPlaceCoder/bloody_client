...
public class SlotUtils {
    public static final List<Integer> INDEX_LIST = new ArrayList<>();
    ...
    public static void init() {
        ...
        INDEX_LIST.add(CHESTPLATE_SLOT);
        INDEX_LIST.add(LEGGINGS_SLOT);
        INDEX_LIST.add(BOOTS_SLOT);
        INDEX_LIST.add(45);
    }
    ...
    private static int creativeInventory(int i) {
        if (!(mc.currentScreen instanceof CreativeInventoryScreen) || (((CreativeInventoryScreenAccessor) mc.currentScreen).getSelectedTab() != ItemGroup.INVENTORY.getIndex()))
            return -1;
