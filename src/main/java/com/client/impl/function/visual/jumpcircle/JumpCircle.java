...
public class JumpCircle extends Function {
    ...
    public final IntegerSetting scaleSpeed = Integer().name("Скорость").enName("Grow Speed").defaultValue(3).min(1).max(6).build();
    public final IntegerSetting lifetime = Integer().name("Время").enName("Life Time").defaultValue(1).min(1).max(10).build();
