...
public class IntegerSettingElement extends AbstractSettingElement {
    ...
    public IntegerSettingElement(AbstractSettings<?> settings, FloatRect rect) {
        super(settings, rect);
    ...
    public void draw(double mx, double my, float alpha) {
        rect.setH(Math.max(IFont.getHeight(IFont.MONTSERRAT_BOLD, name, 6),
                IFont.getHeight(IFont.MONTSERRAT_BOLD, "" + ((IntegerSetting) setting).get(), 6)) + 2 + 3 + 3);

        sliderRect = new FloatRect(rect.getX() + 10,
                rect.getY() + Math.max(IFont.getHeight(IFont.MONTSERRAT_BOLD, name, 6),
                        IFont.getHeight(IFont.MONTSERRAT_BOLD, "" + ((IntegerSetting) setting).get(), 6)) + 2,
                rect.getW() - 20,
                3);

        textRect = new FloatRect(rect.getX2() - 4 - Math.max(IFont.getWidth(IFont.MONTSERRAT_BOLD, "" + ((IntegerSetting) setting).get(), 8), IFont.getWidth(IFont.MONTSERRAT_BOLD, "10", 8)),
                rect.getY().floatValue(),
                Math.max(IFont.getWidth(IFont.MONTSERRAT_BOLD, "" + ((IntegerSetting) setting).get(), 8), IFont.getWidth(IFont.MONTSERRAT_BOLD, "10", 8)),
                IFont.getHeight(IFont.MONTSERRAT_BOLD, "" + ((IntegerSetting) setting).get(), 6));
        ...
        IFont.drawCenteredXY(IFont.MONTSERRAT_BOLD, "" + ((IntegerSetting) setting).get(), textRect.getCenteredX(), textRect.getCenteredY(), inject(active, alpha), 6);
    }
