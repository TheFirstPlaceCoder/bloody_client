...
public class KeybindButton extends SettingButton {
    ...
    public KeybindButton(AbstractSettings<?> setting, FloatRect rect) {
        super(setting, rect);
    }
    ...
    public void draw(double mx, double my, float alpha) {
        ...
        IFont.drawCenteredY(IFont.MONTSERRAT_MEDIUM, setting.getName(), rect.getX() + 4, rect.getCenteredY(), inject(Color.WHITE, alpha), 7);
    }
