...
public class DoubleButton extends SettingButton {
    ...
    public void draw(double mx, double my, float alpha) {
        ...
        IFont.draw(IFont.MONTSERRAT_MEDIUM, "" + ((DoubleSetting) setting).get(), rect.getX2() - 4 - IFont.getWidth(IFont.MONTSERRAT_MEDIUM, "" + ((DoubleSetting) setting).get(), 7), rect.getY() + 2, inject(Color.WHITE, alpha), 7);
    }
